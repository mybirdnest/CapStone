...
The F1 score for the Logistic model is `r format(ConfMatGLM$byClass["F1"], digits = 2, nsmall = 2)`.
...
The F1 score for the Random Forest model is `r format(ConfMatRF$byClass["F1"], digits = 2, nsmall = 2)`.
...
The final prediction using testing data set (`r format(ConfMatFinalRF$byClass["F1"], digits = 2, nsmall = 2)`) appears to have about the same F1 score as using the validation data set (`r format(ConfMatRF$byClass["F1"], digits = 2, nsmall = 2)`)
...
3. The current Random Forest model F1 score is `r format(ConfMatFinalRF$byClass["F1"], digits = 2, nsmall = 2)`. Other classification model such as clustering k-means or other classification model that can produce higher accuracy should be explored.
